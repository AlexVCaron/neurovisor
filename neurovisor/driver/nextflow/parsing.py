...
from ...backend import CacheManager
from .parser.groovy import unpack_nf_component


class NextflowParser:
    @classmethod
    def parse_module(cls, module_path : str):
        return NextflowParser._parse_groovy(module_path)
    ...
    def parse_subworkflow(cls, subworkflow_path: str):
        return NextflowParser._parse_groovy(subworkflow_path)
    ...
    def parse_pipeline(cls, pipeline_path: str):
        return NextflowParser._parse_groovy(pipeline_path)

    @classmethod
    def _parse_groovy(cls, filename):
        with open(filename, "r") as f:
            ...
            return unpack_nf_component(json_tree)
